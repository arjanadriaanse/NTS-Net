...
for small_scale in small_sizes_grid:
	for medium_scale in medium_sizes_grid:
		for large_scale in large_sizes_grid:
			...
			os.system('python train.py ' + str(small_scale) + ' ' + str(medium_scale) + ' ' + str(large_scale))
			#Test for currently generated model
			os.system('python test.py')
			model_accuracy = read_accuracy()
            write_accuracy_for_config(small_scale, medium_scale, large_scale, accuracy)
...
write_accuracy_for_config(best_small, best_medium, best_large, accuracy)
